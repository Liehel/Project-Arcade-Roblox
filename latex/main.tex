...
\begin{figure}[H]
  \centering
  \resizebox{\textwidth}{!}{\input{diagrama/gantt-schedule}}
...
\begin{figure}[H]
  \centering
  \resizebox{\textwidth}{!}{\input{diagrama/architecture-overview}}
...
\begin{figure}[H]
  \centering
  \resizebox{\textwidth}{!}{\input{diagrama/sequence-session}}
...
\begin{figure}[H]
  \centering
  \input{diagrama/avistoucan-flow}
...
\begin{figure}[H]
  \centering
  \input{diagrama/firmamentdefender-flow}
...
\begin{figure}[H]
  \centering
  \input{diagrama/firmamentsiege-flow}
...
\begin{figure}[H]
  \centering
  \input{diagrama/turriscasei-flow}
...
\begin{figure}[H]
  \centering
  \input{diagrama/tapandhold-flow}
...
\begin{figure}[H]
  \centering
  \input{diagrama/scoretable-states}
...
\begin{figure}[H]
  \centering
  \input{diagrama/controller-states}
...
\begin{figure}[H]
  \centering
  \input{diagrama/sequence-multiplayer}
